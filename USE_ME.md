...
There's a full 8-week, 24-day training course in
...
```bash
~/training/course.sh status        # progress bar, streak, all 24 days
...
~/training/course.sh certificate   # once all 24 are done
```
