...
There's a full 8-week, 28-day training course in
...
```bash
~/training/course.sh status        # progress bar, streak, all 28 days
...
~/training/course.sh certificate   # once all 28 are done
```
